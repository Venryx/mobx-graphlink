...
const { v4, parse, stringify } = (_a = uuid.default) !== null && _a !== void 0 ? _a : uuid; // annoying workaround for inconsistent handling seen between dm's "db.buildSeedDBScript" script, and the app-server-js program/pod
