...
export function SetHookUpdatesBlocked(blocked) {
...
export const hookCallRecorders = new Set();
...
for (const [key, func_orig] of Object.entries(React)) {
    if (typeof func_orig == "function" && key.startsWith("use") && key !== "use") {
        ...
        if (key == "useState") {
            hookIntercept = function useState_hookInterceptFromMobXGraphlink(...args) {
