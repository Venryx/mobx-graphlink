...
export const CleanType_values = ["hideField_typename", "hideField_underscore", "removeNullFields"] as const;
export type CleanType = typeof CleanType_values[number];
export function CleanDBData(data, cleanTypes: CleanType[] = CleanType_values.slice()) {
	if (data == null) return;
